...
"""),
    ...
    # 2026-09-21 PI 정정: 김대영 교수는 교수학습지원센터장이 아니라 '교육혁신처장'이다.
    #   함께 적혀 있던 발령일(2026-05-14)과 '후임자가 정해질 때까지'는 앞의 직책에
    #   딸린 내용이라 근거가 사라졌으므로 뺐다. ★ 발령일을 받으면 다시 넣는다.
...
교육혁신처를 이끄십니다
김대영 교수님께서 제주대학교 **교육혁신처장**을 겸해 맡으셨습니다.
대학의 교육과정과 수업의 방향을 함께 살피는 자리인 만큼, 앞으로 보여주실 활약을 기대합니다.
</aside>
"""),
