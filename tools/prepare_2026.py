...
"""),
    ...
    #   2026.03.01. 발령, 임용기간 2036.02.29.까지. 저장소·드라이브 어디에도
    #   인물 사진이 없어 이 카드만 사진 없이 나간다. ★ 사진을 받으면 넣는다.
...
올해는 보직도 여럿 맡으셨습니다. 3월 30일자로 **교육혁신처장**을 맡으시며 **원격교육원장 · 교양교육원장 · 교육성과관리센터장**을 함께 겸하게 되셨고(임기 2028년 3월 29일까지), 5월 14일에는 **교수학습지원센터장**까지 맡아 후임자가 정해질 때까지 센터를 이끄십니다.
...
부교수로 승진하셨습니다
연준모 교수님께서 2026년 3월 1일자로 **부교수**로 승진하셨습니다. 진심으로 축하드립니다. 임용기간은 2036년 2월 29일까지입니다.
...
"""),
    ...
    # 2026-09-21 PI 확인 사항:
    #   · 서명석(제주대 교육대학) 저서는 검색으로 확인. 동일인 근거 — 교수진 소개의
    ...
    #     PI 판단으로 이번 호에 다시 싣는다(2026-09-21). 종이책 원간일을 함께 적는다.
...
2021년 10월 30일 출간 (전자책 2025년 4월 30일)
---
